...
class CUApiClient {
    ...
    func fetchResource<T : Decodable where T.DecodedType == T>(request: NSURLRequest, rootKey: String? = nil, completion: CUApiClientResult<T> -> Void) {
    ...
    func fetchCollection<T: Decodable where T.DecodedType == T>(request: NSURLRequest, rootKey: String? = nil, completion: CUApiClientResult<[T]> -> Void) {
    ...
    func fetch<T>(request: NSURLRequest, parseBlock: JSON -> T?, completion: CUApiClientResult<T> -> Void) {
